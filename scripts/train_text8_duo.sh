...
# Single A6000: batch_size=256 (seq_len=256, small vocab)
# global_batch_size=512 with accumulate_grad_batches=2
python -u -m main \
  loader.batch_size=256 \
  loader.eval_batch_size=256 \
  data=text8 \
  wandb.name=duo-text8 \
  model=small \
  algo=duo \
  model.length=256 \
